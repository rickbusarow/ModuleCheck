...
dependencies {
  ...
  dependencySync("com.google.dagger:dagger-compiler:2.42")
  dependencySync("com.google.dagger:dagger:2.42")
  ...
  dependencySync("com.rickbusarow.dispatch:dispatch-android-viewmodel:1.0.0-SNAPSHOT")
  ...
  dependencySync("com.squareup.anvil:compiler-api:2.4.0")
  dependencySync("com.squareup.anvil:compiler-utils:2.4.0")
  dependencySync("com.squareup.anvil:compiler:2.4.0")
  ...
  dependencySync("io.kotest:kotest-assertions-core-jvm:5.3.0")
  dependencySync("io.kotest:kotest-property-jvm:5.3.0")
  dependencySync("io.kotest:kotest-runner-junit5-jvm:5.3.0")

  dependencySync("javax.inject:javax.inject:1")

  dependencySync("net.swiftzer.semver:semver:1.2.0")

  dependencySync("org.antlr:antlr4-runtime:4.10.1")
  dependencySync("org.antlr:antlr4:4.10.1")
  dependencySync("org.codehaus.groovy:groovy-xml:3.0.10")
  dependencySync("org.codehaus.groovy:groovy:3.0.10")
  dependencySync("org.jetbrains.dokka:dokka-gradle-plugin:1.6.21")
  dependencySync("org.jetbrains.kotlin:kotlin-annotation-processing-embeddable:1.6.21")
  dependencySync("org.jetbrains.kotlin:kotlin-compiler-embeddable:1.6.21")
  dependencySync("org.jetbrains.kotlin:kotlin-gradle-plugin-api:1.6.21")
  dependencySync("org.jetbrains.kotlin:kotlin-gradle-plugin:1.6.21")
  dependencySync("org.jetbrains.kotlin:kotlin-reflect:1.6.21")
  dependencySync("org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.6.21")
  ...
  dependencySync("org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.6.1")
  dependencySync("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.1")
