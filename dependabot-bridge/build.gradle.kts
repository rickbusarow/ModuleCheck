...
dependencies {
  ...
  dependencySync("io.kotest:kotest-assertions-core-jvm:5.0.2")
  dependencySync("io.kotest:kotest-property-jvm:5.0.2")
  dependencySync("io.kotest:kotest-runner-junit5-jvm:5.0.2")
