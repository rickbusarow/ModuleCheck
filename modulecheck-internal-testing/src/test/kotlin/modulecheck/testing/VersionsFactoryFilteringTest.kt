    ...
    versions(true)
      ...
      .asClue {
        ...
        versions(true).joinToString("\n") shouldBe listOf(
          ...
          row("7.5.1", "7.4.0", "2.4.3", "1.7.0"),
          row("7.5.1", "7.4.0", "2.4.3", "1.7.10"),
          row("7.5.1", "7.4.0", "2.4.3", "1.7.22"),
          ...
          row("7.6", "7.4.0", "2.4.3", "1.7.0"),
          row("7.6", "7.4.0", "2.4.3", "1.7.10"),
          row("7.6", "7.4.0", "2.4.3", "1.7.22")
        )
