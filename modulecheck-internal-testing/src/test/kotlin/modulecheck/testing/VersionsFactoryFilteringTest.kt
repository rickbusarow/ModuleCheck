    ...
    versions(true)
      ...
      .asClue {
        ...
        versions(true).joinToString("\n") shouldBe listOf(
          ...
          row("7.2", "7.1.3", "2.4.2", "1.7.21"),
          row("7.5.1", "7.1.3", "2.4.2", "1.7.0"),
          row("7.5.1", "7.1.3", "2.4.2", "1.7.10"),
          row("7.5.1", "7.1.3", "2.4.2", "1.7.21"),
          row("7.5.1", "7.2.2", "2.4.2", "1.7.0"),
          row("7.5.1", "7.2.2", "2.4.2", "1.7.10"),
          row("7.5.1", "7.2.2", "2.4.2", "1.7.21"),
          row("7.5.1", "7.3.1", "2.4.2", "1.7.0"),
          row("7.5.1", "7.3.1", "2.4.2", "1.7.10"),
          row("7.5.1", "7.3.1", "2.4.2", "1.7.21"),
          row("7.6", "7.1.3", "2.4.2", "1.7.0"),
          row("7.6", "7.1.3", "2.4.2", "1.7.10"),
          row("7.6", "7.1.3", "2.4.2", "1.7.21"),
          row("7.6", "7.2.2", "2.4.2", "1.7.0"),
          row("7.6", "7.2.2", "2.4.2", "1.7.10"),
          row("7.6", "7.2.2", "2.4.2", "1.7.21"),
          row("7.6", "7.3.1", "2.4.2", "1.7.0"),
          row("7.6", "7.3.1", "2.4.2", "1.7.10"),
          row("7.6", "7.3.1", "2.4.2", "1.7.21")
        )
