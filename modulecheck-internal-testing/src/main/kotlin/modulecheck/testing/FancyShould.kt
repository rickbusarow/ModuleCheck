 ...
 * @since 0.12.4
 */
fun <R> trimmedAssert(vararg excludeFromStack: KClass<*>, assertion: suspend () -> R): R =
  Unit.trimmedAssert(*excludeFromStack) { assertion() }
 ...
 * @since 0.12.4
 */
fun <T, R> T.trimmedAssert(vararg excludeFromStack: KClass<*>, assertion: suspend T.() -> R): R {
