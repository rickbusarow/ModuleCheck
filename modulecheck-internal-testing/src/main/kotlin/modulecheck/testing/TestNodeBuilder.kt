...
//  */
// class TestNodeBuilder_OLD @PublishedApi internal constructor(
//   val name: String,
//   val rootStackFrame: StackFrame,
//   val parent: TestNodeBuilder_OLD?
// ) {
...
//   ): TestNodeBuilder_OLD = this@TestNodeBuilder_OLD.apply {
...
//     crossinline action: TestNodeBuilder_OLD.(E) -> Unit
//   ): TestNodeBuilder_OLD = this@TestNodeBuilder_OLD.apply {
...
//    * @param init a lambda with receiver that initializes the [TestNodeBuilder].
//    */
//   inline fun container(name: String, crossinline init: TestNodeBuilder_OLD.() -> Unit) {
//
//     nodes.add {
//       TestNodeBuilder_OLD(
//         name = name,
