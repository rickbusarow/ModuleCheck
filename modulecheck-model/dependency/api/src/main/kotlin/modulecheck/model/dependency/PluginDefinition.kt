 ...
 *
 * @property name A descriptive name for this plugin,
 *   such as 'Kotlin kapt' or 'Android Gradle Plugin'
 ...
 * @property precompiledAccessorOrNull A special accessor invoked
 *   like a property, with or without backticks, like `base`.
 * @property kotlinFunctionArgumentOrNull The `kotlin(...)` function used
