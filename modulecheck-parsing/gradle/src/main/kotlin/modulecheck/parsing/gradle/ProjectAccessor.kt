...
sealed interface ProjectAccessor {
  ...
  data class StringProjectAccessor(
    ...
    override val projectPath: ProjectPath.StringProjectPath
  ) : ProjectAccessor {
    init {
  ...
  data class TypeSafeProjectAccessor(
    override val statementText: String,
    override val projectPath: ProjectPath.TypeSafeProjectPath
  ) : ProjectAccessor {
    init {
  ...
  companion object {
    fun from(rawString: String, projectPath: ProjectPath): ProjectAccessor {
      ...
      return when (projectPath) {
        is ProjectPath.StringProjectPath -> StringProjectAccessor(rawString, projectPath)
        is ProjectPath.TypeSafeProjectPath -> TypeSafeProjectAccessor(rawString, projectPath)
      }
    }
  }
}
