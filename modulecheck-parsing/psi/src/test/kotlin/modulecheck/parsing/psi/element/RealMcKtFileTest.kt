...
import modulecheck.parsing.psi.KotlinFileTest
...
import modulecheck.parsing.source.element.McProperty.McKtProperty.KtConstructorProperty
...
internal class RealMcKtFileTest : ProjectTest(), NamedSymbolTest {
  ...
  fun McProject.createFile(
    ...
    return runBlocking(Trace.start(KotlinFileTest::class)) {
