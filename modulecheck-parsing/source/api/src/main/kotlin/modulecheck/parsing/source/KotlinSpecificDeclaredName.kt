 ...
 *
 * These Kotlin-specific declarations will only match to the [KotlinReferenceName] type.
 *
 * @see KotlinReferenceName
 * @see JavaSpecificDeclaredName
 */
sealed interface KotlinSpecificDeclaredName : DeclaredName, KotlinCompatibleDeclaredName

class TopLevelKotlinSpecificDeclaredName(
